 ...
 * Author: harveybc
 *
 * Created on 30/05/2015, 12:41:12 AM
 */
#include <stdlib.h>
#include <iostream>
#include <memory>
...
/* Prueba de Neuron_d (que usa mensajes tipo float) */
void test1(float input_0, float input_1) {
    int tmp_int=0;
    float tmp_float;
    ...
    // Se colocan valores float en las entradas de la red neuronal
    ...
    swann->evaluate();
    // Se extrae el valor de la salida  en tmp_float
    tmp_int=swann->read_output(tmp_float,0); // extrae el valor de la neurona 0
    //Se imprime resultado
    std::cout << "Input 0  = " << input_0 << std::endl;
    std::cout << "Input 1  = " << input_1 << std::endl;
    std::cout << "Output 0 = " << tmp_float << std::endl;
}
