...
${OBJECTDIR}/fractal_machine.o: fractal_machine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/D/Dropbox/Singularity/Singularity -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fractal_machine.o fractal_machine.cpp
...
${OBJECTDIR}/fractal_machine_nomain.o: ${OBJECTDIR}/fractal_machine.o fractal_machine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/D/Dropbox/Singularity/Singularity -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fractal_machine_nomain.o fractal_machine.cpp;\
	else  \
