...
${OBJECTDIR}/Neuron_d_in.o: Neuron_d_in.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Neuron_d_in.o Neuron_d_in.cpp
...
${OBJECTDIR}/Expert_SANN_nomain.o: ${OBJECTDIR}/Expert_SANN.o Expert_SANN.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Expert_SANN_nomain.o Expert_SANN.cpp;\
	else  \
...
${OBJECTDIR}/Expert_Simple_nomain.o: ${OBJECTDIR}/Expert_Simple.o Expert_Simple.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Expert_Simple_nomain.o Expert_Simple.cpp;\
	else  \
...
${OBJECTDIR}/FractalMachine_nomain.o: ${OBJECTDIR}/FractalMachine.o FractalMachine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FractalMachine_nomain.o FractalMachine.cpp;\
	else  \
...
${OBJECTDIR}/FractalTape_nomain.o: ${OBJECTDIR}/FractalTape.o FractalTape.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FractalTape_nomain.o FractalTape.cpp;\
	else  \
...
${OBJECTDIR}/Neuron_d_nomain.o: ${OBJECTDIR}/Neuron_d.o Neuron_d.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Neuron_d_nomain.o Neuron_d.cpp;\
	else  \
...
${OBJECTDIR}/Neuron_d_in_nomain.o: ${OBJECTDIR}/Neuron_d_in.o Neuron_d_in.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Neuron_d_in_nomain.o Neuron_d_in.cpp;\
	else  \
...
${OBJECTDIR}/TX_Expert_Simple_nomain.o: ${OBJECTDIR}/TX_Expert_Simple.o TX_Expert_Simple.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TX_Expert_Simple_nomain.o TX_Expert_Simple.cpp;\
	else  \
...
${OBJECTDIR}/TX_Neuron_d_nomain.o: ${OBJECTDIR}/TX_Neuron_d.o TX_Neuron_d.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TX_Neuron_d_nomain.o TX_Neuron_d.cpp;\
	else  \
...
${OBJECTDIR}/TX_SANN_nomain.o: ${OBJECTDIR}/TX_SANN.o TX_SANN.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TX_SANN_nomain.o TX_SANN.cpp;\
	else  \
