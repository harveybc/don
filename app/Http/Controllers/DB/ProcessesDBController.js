...
class ProcessesDBController {
    ...
    * AdminView(request, response) {
        ...
        yield response.sendView('admin_view',{
            ...
            content: JSON.stringify(testd).replace(/&quot;/ig,'"') 
